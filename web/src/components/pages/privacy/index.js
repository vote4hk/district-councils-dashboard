...
export default () => {
  return (
    <>
      <h1>Privacy Policy for vote4.hk</h1>

      <p>
        At vote4.hk, accessible from vote4.hk, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by vote4.hk and how we use
        it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in vote4.hk. This policy is not applicable to any
      ...
      <p>
        vote4.hk follows a standard procedure of using log files. These files
      ...
      <p>
        ...
        advertising partners of vote4.hk.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on vote4.hk, which are sent
      ...
      <p>
        Note that vote4.hk has no access to or control over these cookies that
      ...
      <p>
        vote4.hk's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        vote4.hk does not knowingly collect any Personal Identifiable
